      ...
      body: Column(
        children: [
                ...
                return Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 15,),
                      Text(onBoardingItems[i].title,style: TextStyle(color: Colors.black,fontSize: 25,fontWeight: FontWeight.bold),),
                      Text(onBoardingItems[i].discription,style: TextStyle(color: Colors.black,fontSize: 18,),),
                  ],
                  ),
                );
              },
          ...
          Container(
            child: Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: List.generate(onBoardingItems.length, (index) => Container(
                height: 10,
          ...
          Container(
            ...
            child: CustomButton(
              text: 'Skip',
              onPressed: (){GoRouter.of(context).push(AppRouter.lawyerName);},
            )
          )
        ],
      ),
